<template>
  ...
  <ChooseImage ref="ChooseImageRef" :limit="9" :show-btn="false" />
</template>
...
const init = {
  ...
  toolbar_mode: 'none',
  plugins:
      'wordcount visualchars visualblocks template searchreplace save quickbars preview pagebreak nonbreaking media insertdatetime importcss help fullscreen directionality codesample code charmap link code table lists advlist anchor autolink autoresize autosave',
  toolbar:
